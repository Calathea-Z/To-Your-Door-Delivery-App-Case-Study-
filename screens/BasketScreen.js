    ...
    <SafeAreaView className='flex-1 bg-white'>
      <View className='flex-1 bg-gray-100'>
        ...
        <View className='flex-row items-center space-x-4 px-4 py-3 bg-white my-5'>
            <Image source={{uri: "https://links.papareact.com/wru"}} className='h-7 w-7 bg-gray pd-4 rounded-full' />
            <Text className='flex-1'>Estimated Delivery Time: 45-60 min</Text>
            <TouchableOpacity>
